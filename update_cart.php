...
<body>
    ...
    <div class="container" id="details-data">
        ...
        <?php $customer_idparm = $_GET['id'];
          $bouquet_idparm = $_GET['bouquet_id'];
          $quantityparm = $_GET['quantity'];
          $nameParm = $_GET['name'];  ?>


        <fieldset>
            <legend>Update Quantity in Cart</legend>
            <div class="form">
                <form name="order_form">
                    <div class="option">
                        <input type="text" class="form-control item" id="bouquet" disabled="true" value=<?php echo
                            $nameParm; ?> alt =
                        <?php echo  $bouquet_idparm; ?>>
                    </div>
                    <input type="number" class="form-control item" id="quantity" name="quantity" placeholder="Quantity"
                        value=<?php echo $quantityparm; ?>>
                    <input type="button" class="btnSubmt" id="updateCart" value="Update Cart">
