        ...
        <fieldset>
            ...
            <div id="addFormDiv">
                <form id="add_form" name="add_form">
                    <div>
                        <input type="text" class="form-control item" id="name" name="name" placeholder="Product name"
                            required="true">
                        <input type="text" class="form-control item" id="unitprice" name="unitprice"
                            placeholder="Unit price" required="true">
                        <input type="text" class="form-control item" id="stock" name="stock" placeholder="Stock"
                            required="true">
                        <div class="submitbtn">
                            <input type="button" class="btnSubmt" id="add_new_products" value="Save Product">
                            <!-- <input type="button" class="btnSubmt" id="addToCart" value="Add to Cart"> -->
                        </div>
                        <div class="submitbtn">
                            <input type="button" class="btnSubmt" id="viewwProducts" value="View Products">
                        </div>
                    </div>
                </form>
            </div>
